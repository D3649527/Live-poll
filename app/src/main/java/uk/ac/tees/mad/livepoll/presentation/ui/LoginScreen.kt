...
fun LoginScreen(vm : PollViewModel, navController: NavController) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = "Log in", fontSize = 50.sp)
        Spacer(modifier = Modifier.height(5.dp))
        Button(onClick = { navigateWithBackStack(navController, ApplicationNavigation.Signup.route) }, shape = RoundedCornerShape(5.dp), colors = ButtonDefaults.buttonColors(
            Color.Gray)) {
